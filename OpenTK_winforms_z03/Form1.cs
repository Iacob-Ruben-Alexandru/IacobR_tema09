...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        /// <summary>
        /// pentru desenarea segmentelor de intre cele 2 cercuri
        /// </summary>
        /// <param name="zFront"></param>
        /// <param name="zBack"></param>
        /// <param name="scale"></param>
        void drawCylinderWalls(float zFront, float zBack, float scale)
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            ...
            GL.TexCoord2(0.0f, 0.0f); GL.Vertex3(1.0000f * scale, 0.0000f * scale, zFront);
            GL.TexCoord2(0.1f, 0.0f); GL.Vertex3(0.8090f * scale, 0.5878f * scale, zFront);
            GL.TexCoord2(0.1f, 1.0f); GL.Vertex3(0.8090f * scale, 0.5878f * scale, zBack);
            GL.TexCoord2(0.0f, 1.0f); GL.Vertex3(1.0000f * scale, 0.0000f * scale, zBack);

            GL.TexCoord2(0.1f, 0.0f); GL.Vertex3(0.8090f * scale, 0.5878f * scale, zFront);
            GL.TexCoord2(0.2f, 0.0f); GL.Vertex3(0.3090f * scale, 0.9511f * scale, zFront);
            GL.TexCoord2(0.2f, 1.0f); GL.Vertex3(0.3090f * scale, 0.9511f * scale, zBack);
            GL.TexCoord2(0.1f, 1.0f); GL.Vertex3(0.8090f * scale, 0.5878f * scale, zBack);

            GL.TexCoord2(0.2f, 0.0f); GL.Vertex3(0.3090f * scale, 0.9511f * scale, zFront);
            GL.TexCoord2(0.3f, 0.0f); GL.Vertex3(-0.3090f * scale, 0.9511f * scale, zFront);
            GL.TexCoord2(0.3f, 1.0f); GL.Vertex3(-0.3090f * scale, 0.9511f * scale, zBack);
            GL.TexCoord2(0.2f, 1.0f); GL.Vertex3(0.3090f * scale, 0.9511f * scale, zBack);

            GL.TexCoord2(0.3f, 0.0f); GL.Vertex3(-0.3090f * scale, 0.9511f * scale, zFront);
            GL.TexCoord2(0.4f, 0.0f); GL.Vertex3(-0.8090f * scale, 0.5878f * scale, zFront);
            GL.TexCoord2(0.4f, 1.0f); GL.Vertex3(-0.8090f * scale, 0.5878f * scale, zBack);
            GL.TexCoord2(0.3f, 1.0f); GL.Vertex3(-0.3090f * scale, 0.9511f * scale, zBack);

            GL.TexCoord2(0.4f, 0.0f); GL.Vertex3(-0.8090f * scale, 0.5878f * scale, zFront);
            GL.TexCoord2(0.5f, 0.0f); GL.Vertex3(-1.0000f * scale, 0.0000f * scale, zFront);
            GL.TexCoord2(0.5f, 1.0f); GL.Vertex3(-1.0000f * scale, 0.0000f * scale, zBack);
            GL.TexCoord2(0.4f, 1.0f); GL.Vertex3(-0.8090f * scale, 0.5878f * scale, zBack);

            GL.TexCoord2(0.5f, 0.0f); GL.Vertex3(-1.0000f * scale, 0.0000f * scale, zFront);
            GL.TexCoord2(0.6f, 0.0f); GL.Vertex3(-0.8090f * scale, -0.5878f * scale, zFront);
            GL.TexCoord2(0.6f, 1.0f); GL.Vertex3(-0.8090f * scale, -0.5878f * scale, zBack);
            GL.TexCoord2(0.5f, 1.0f); GL.Vertex3(-1.0000f * scale, 0.0000f * scale, zBack);

            GL.TexCoord2(0.6f, 0.0f); GL.Vertex3(-0.8090f * scale, -0.5878f * scale, zFront);
            GL.TexCoord2(0.7f, 0.0f); GL.Vertex3(-0.3090f * scale, -0.9511f * scale, zFront);
            GL.TexCoord2(0.7f, 1.0f); GL.Vertex3(-0.3090f * scale, -0.9511f * scale, zBack);
            GL.TexCoord2(0.6f, 1.0f); GL.Vertex3(-0.8090f * scale, -0.5878f * scale, zBack);

            GL.TexCoord2(0.7f, 0.0f); GL.Vertex3(-0.3090f * scale, -0.9511f * scale, zFront);
            GL.TexCoord2(0.8f, 0.0f); GL.Vertex3(0.3090f * scale, -0.9511f * scale, zFront);
            GL.TexCoord2(0.8f, 1.0f); GL.Vertex3(0.3090f * scale, -0.9511f * scale, zBack);
            GL.TexCoord2(0.7f, 1.0f); GL.Vertex3(-0.3090f * scale, -0.9511f * scale, zBack);

            GL.TexCoord2(0.8f, 0.0f); GL.Vertex3(0.3090f * scale, -0.9511f * scale, zFront);
            GL.TexCoord2(0.9f, 0.0f); GL.Vertex3(0.8090f * scale, -0.5878f * scale, zFront);
            GL.TexCoord2(0.9f, 1.0f); GL.Vertex3(0.8090f * scale, -0.5878f * scale, zBack);
            GL.TexCoord2(0.8f, 1.0f); GL.Vertex3(0.3090f * scale, -0.9511f * scale, zBack);

            GL.TexCoord2(0.9f, 0.0f); GL.Vertex3(0.8090f * scale, -0.5878f * scale, zFront);
            GL.TexCoord2(1.0f, 0.0f); GL.Vertex3(1.0000f * scale, 0.0000f * scale, zFront);
            GL.TexCoord2(1.0f, 1.0f); GL.Vertex3(1.0000f * scale, 0.0000f * scale, zBack);
            GL.TexCoord2(0.9f, 1.0f); GL.Vertex3(0.8090f * scale, -0.5878f * scale, zBack);
        ...
        private void drawCircle(float x)
        {
            ...
            GL.TexCoord2(0.05, 1.0);
            GL.Vertex3(1.0000f * scale, 0.0000f * scale, 0.0f);

            GL.TexCoord2(0.55, 0.95);
            GL.Vertex3(0.8090f * scale, 0.5878f * scale, 0.0f);

            GL.TexCoord2(0.48, 1.02);
            GL.Vertex3(0.3090f * scale, 0.9511f * scale, 0.0f);

            GL.TexCoord2(0.32, 0.97);
            GL.Vertex3(-0.3090f * scale, 0.9511f * scale, 0.0f);

            GL.TexCoord2(0.08, 0.92);
            GL.Vertex3(-0.8090f * scale, 0.5878f * scale, 0.0f);

            GL.TexCoord2(0.0, 0.48);
            GL.Vertex3(-1.0000f * scale, 0.0000f * scale, 0.0f);

            GL.TexCoord2(0.1, 0.21);
            GL.Vertex3(-0.8090f * scale, -0.5878f * scale, 0.0f);

            GL.TexCoord2(0.34, 0.05);
            GL.Vertex3(-0.3090f * scale, -0.9511f * scale, 0.0f);

            GL.TexCoord2(0.66, 0.03);
            GL.Vertex3(0.3090f * scale, -0.9511f * scale, 0.0f);

            GL.TexCoord2(0.9, 0.21);
            GL.Vertex3(0.8090f * scale, -0.5878f * scale, 0.0f);

            GL.TexCoord2(1.0, 0.5);
            GL.Vertex3(1.0000f * scale, 0.0000f * scale, 0.0f);
        ...
        private void LoadTextures() {
            ...
            LoadTexture(textures[2], "Transparent.png");
        }
